...
- **Workout Prep** — recovery-aware target weights; TUT progression when locker weight is maxed; prep insights per exercise; multi-workout queue; shared **Voorbereiden** header; optional TV preview before start
